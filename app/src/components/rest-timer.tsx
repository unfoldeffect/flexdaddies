...
export function RestTimer() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[104px] right-5 z-50 flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#0b2545] bg-[#c9a227] shadow-lg transition-transform active:scale-95"
      style={ringStyle}
    >
